...
def main():
    ...
    temp = np.random.uniform(low=5950, high=6050, size=(nwalkers,))
    logg = np.random.uniform(low=3.45, high=3.55, size=(nwalkers,))
    #M = np.random.uniform(low=0.1, high = 10, size=(nwalkers,))
    #R = np.random.uniform(low=0.1, high = 10, size=(nwalkers,))
    vsini = np.random.uniform(low=14.5, high=15.5, size=(nwalkers,))
    vz = np.random.uniform(low=14.5, high=15.5., size=(nwalkers,))
    Av = np.random.uniform(low=0.7, high = 1.5, size=(nwalkers,))
    flux_factor = np.random.uniform(low=9.e-28, high=1.1e-27, size=(nwalkers,))
    ...
    p0 = np.array([temp, logg, vsini, vz, Av, flux_factor]).T#,c0_22,c1_22,c2_22,c0_23,c1_23,c2_23]).T
