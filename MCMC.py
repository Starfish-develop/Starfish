...
def main():
    ...
    temp = np.random.uniform(low=4150, high=5000, size=(nwalkers,))
    logg = np.random.uniform(low=3.0, high=4.5, size=(nwalkers,))
    ...
    flux_factor = np.random.uniform(low=1e-28, high=2e-27, size=(nwalkers,))
