...
temp = np.random.uniform(low=5200, high = 6800, size=(nwalkers,))
logg = np.random.uniform(low=2.5, high=5.0, size=(nwalkers,))
...
c0 = np.random.uniform(low=1e27, high = 1e28, size=(nwalkers,))
