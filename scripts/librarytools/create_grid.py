from StellarSpectra.grid_tools import PHOENIXGridInterface, HDF5Creator, TRES

raw_library_path = "libraries/raw/PHOENIX/"
mygrid = grid_tools.PHOENIXGridInterface(base=raw_library_path, wl_range=[4700, 5500])
