...
class TestModel:
    def setup_class(self):
        self.DataSpectrum = DataSpectrum.open("/home/ian/Grad/Research/Disks/StellarSpectra/StellarSpectra/tests/WASP14/WASP-14_2009-06-15_04h13m57s_cb.spec.flux", orders=np.array([21,22,23]))
...
#TODO: These techniques need to be refactored to follow OrderModel
