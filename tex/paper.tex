...
%% \todo{tests regarding interpolation accuracy}.
...
% SA: The following too paragraphs are too preachy, and address a different issue than we ended up 
% focusing on in this paper.  You can remove them entirely.
%
