...
iterations, $N_G$, are determined empirically with a convergence criterion .... \comm{how exactly?}
...
%\begin{equation}
%  p(\vT | \vD) =  p(\vt_{\ast}, \cheb, \cov | \vD ) \propto p(\vD | \vT) p(\vT).
%\end{equation}
