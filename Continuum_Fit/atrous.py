...
def write_data():
    ...
    flux = (wls) ** (0.2) + 10 * gauss(wls, mu=150, sigma=2) - 3. * gauss(wls, mu=240, sigma=1) + normal(scale=0.1,
                                                                                                         size=(
                                                                                                         len(wls, )))
...
flux_file = pf.open(
    "../HiResFITS/PHOENIX-ACES-AGSS-COND-2011/Z-0.0/lte06000-4.50-0.0.PHOENIX-ACES-AGSS-COND-2011-HiRes.fits")
